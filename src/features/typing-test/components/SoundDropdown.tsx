        ...
        >
            <div className="py-2">
                ...
                >
                    ...
                    <div className={`w-8 h-4 rounded-full relative transition-colors ${soundEnabled ? 'bg-teal-500' : 'bg-gray-600'}`}>
                ...
                {soundEnabled && (
                    <>
                        ...
                        <div className="px-4 py-1.5 text-xs font-semibold text-gray-500 uppercase">
                            {t('chineseStyle')} {/* Reusing a general "Style" label if available or just generic */}
