  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
        ...
        <motion.div layout className="flex items-center gap-4 relative">
        ...
        <div className="flex justify-center items-end gap-6 mb-16 px-4">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-center">
              ...
              <div className="text-teal-400 font-mono text-xl">
                {data[1]?.cpm}{' '}
          ...
          <div className="flex flex-col items-center -translate-y-4">
            ...
            <div className="text-center">
              ...
              <div className="text-teal-400 font-mono text-3xl font-bold">
                {data[0]?.cpm}{' '}
                <span className="text-sm text-gray-500 font-normal">CPM</span>
              </div>
              <div className="text-xs text-gray-500 mt-1">
                {data[0]?.accuracy}% {t('accuracy')}
              </div>
            </div>
          </div>
